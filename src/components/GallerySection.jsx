...
const GallerySection = () => <section className="section-padding bg-card">
    <div className="container-custom">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3">
        {galleryItems.map((dest, i) => <div
  key={dest.id}
  className={`relative group overflow-hidden rounded-xl cursor-pointer ${i === 0 || i === 5 ? "md:col-span-2 md:row-span-2" : ""}`}
>
            <SafeImage
  src={dest.image}
  alt={dest.title}
...
var stdin_default = GallerySection;
export {
