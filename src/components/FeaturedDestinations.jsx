...
const FeaturedDestinations = () => <section className="section-padding bg-background">
    <div className="container-custom">
      ...
      <AutoCarousel autoplayInterval={4e3}>
        {destinations.slice(0, 10).map((dest) => <Link
  key={dest.id}
...
var stdin_default = FeaturedDestinations;
export {
