...
const Auth = () => {
  ...
  return <div className="pt-20 min-h-screen bg-background flex items-center justify-center px-4">
      <motion.div
  ...
  >
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          {mode === "login" && <button type="button" onClick={() => setMode("forgot")} className="text-xs text-primary hover:underline">
              Forgot password?
            </button>}
        ...
        <p className="text-center text-sm text-muted-foreground mt-6">
          {mode === "forgot" ? <button onClick={() => setMode("login")} className="text-primary font-medium hover:underline flex items-center gap-1 mx-auto">
